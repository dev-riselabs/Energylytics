...
function AuthLayout() {
  ...
  return (
    <main className="auth-bg min-h-screen h-full relative px-15 py-10">
      ...
      <div className=" bg-white rounded-2xl flex p-2 w-full relative z-2 h-full">
        <div className={`flex-1 h-auto rounded-2xl flex flex-col gap-3 auth-bg relative overflow-hidden p-5 ${isSignUp ? 'order-2' :''}`}>
