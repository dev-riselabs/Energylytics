  ...
  return (
    <section className="bg-zinc800 px-5 sm:px-7 md:px-15 py-15 grid grid-cols-1 gap-6 md:gap-0 md:grid-cols-5">
      <img
        ...
        alt=""
        className="rounded-4xl w-full h-full md:col-start-1 md:col-span-3 md:row-start-1 md:min-h-104"
      />
      <div className="bg-green60 rounded-4xl p-7 sm:p-10 flex flex-col gap-7 md:col-start-3 md:col-span-3 md:row-start-1 md:z-10 md:self-center">
