...
function EnviromentalEducation() {
  return (
     <section className="bg-green60 px-5 sm:px-7 md:px-15 py-15 grid grid-cols-1 gap-6 md:gap-0 md:grid-cols-5">
      ...
      <div className="bg-white rounded-4xl px-7 sm:px-10 py-7 sm:py-15 flex flex-col gap-7 md:col-start-1 md:col-span-3 md:row-start-1 md:z-10 md:self-center">
        <h3 className="text-green25 text-xl sm:text-2xl font-medium font-manrope">
      ...
      <img
        ...
        alt=""
        className="rounded-4xl w-full h-60 md:col-start-3 md:col-span-3 md:row-start-1 object-cover md:h-104"
      />
    </section>
  )
}
