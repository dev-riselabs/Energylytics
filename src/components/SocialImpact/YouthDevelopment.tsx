...
function YouthDevelopment() {
  return (
    <section className="bg-green60 px-5 sm:px-7 md:px-15 py-15 grid grid-cols-1 md:grid-cols-5">
      <div className="bg-white rounded-4xl px-10 py-15 flex flex-col gap-5 md:col-start-3 md:col-span-3 md:row-start-1 md:z-10 md:self-center">
        <h2 className="text-green25 font-manrope text-2xl font-medium">
          YOUTH & SKILLS DEVELOPMENT
        </h2>
        <p className="text-base text-slate font-manrope">
