function Powered() {
  return (
    <section className="py-20 px-5 sm:px-10 md:px-20 font-inter">
      <div className="h-75 rounded-4xl flex items-center justify-center gap-6 data-bg relative overflow-hidden">
        ...
        <div className="flex flex-col gap-7.5 items-center relative z-2">
          ...
          <p className="text-xl text-white max-w-[50ch] text-center">
