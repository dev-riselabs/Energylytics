      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-15 items-center">
        ...
        <div className="flex flex-col gap-4 sm:gap-6 justify-center order-2 lg:order-1">
          ...
          <p className="text-slate50 text-sm sm:text-base md:text-lg leading-relaxed">
            We collaborate with private energy companies, industrial energy consumers,
            utilities, clean-energy developers, manufacturers and service providers to
            optimize operations, reduce costs and accelerate the clean-energy transition.
            Our services include energy analytics, AI-powered optimization, feasibility
            studies, strategic advisory and market intelligence to enhance competitiveness
            and sustainability.
          </p>
        </div>
