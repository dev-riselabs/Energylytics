function PartnershipPhilosophy() {
  return (
    <section className="px-5 sm:px-7 md:px-15 py-15 bg-zinc800 flex flex-col gap-8">
      <h4 className="text-slate font-manrope text-2xl font-medium text-center">
        OUR PARTNERSHIP PHILOSOPHY
      </h4>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
        <div className="flex flex-col gap-1 font-manrope md:justify-center">
          <p className="text-xl text-slate50">
          ...
          <p className="text-xl text-slate50 font-bold">
        ...
        <img src="/philosophy.png" alt="" className="rounded-4xl object-center object-cover"/>
      </div>
    </section>
  );
}
