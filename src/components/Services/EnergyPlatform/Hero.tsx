  ...
  return (
    <section className="bg-zinc600 px-5 sm:px-7 md:px-15 py-15 grid grid-cols-1 md:grid-cols-2 gap-6 font-inter">
        <div className="flex flex-col gap-6.5 justify-center">
            <h1 className="text-3xl sm:text-[32px] font-bold text-slate">Intelligence for Africa's Energy Future</h1>
            <p className="text-lg sm:text-xl text-slate">The comprehensive Energy Insights Platform for real-time monitoring, predictive modeling and automated reporting on renewable assets across the continent.</p>
      ...
      <img src="/grid.png" alt="" className="object-cover rounded-3xl h-90 sm:h-103 w-full"/>
    </section>
  );
}
