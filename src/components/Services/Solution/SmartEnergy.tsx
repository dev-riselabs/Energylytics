...
function SmartEnergy() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-7 px-5 sm:px-7 md:px-15 py-15">
      <div className="grid grid-cols-2 gap-5">
        {features.map(({ title, icon: Icon, description }) => (
          <div
            key={title}
            className={`rounded-2xl p-7 sm:p-4 lg:p-7 flex flex-col gap-5.5 flex-1 border border-zinc `}
          >
