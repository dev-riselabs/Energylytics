function RenewableEnergy() {
  return (
    <section className="py-15 px-5 sm:px-10 md:px-20 font-inter bg-zinc600">
      <div className="h-105 rounded-4xl flex items-center justify-center gap-6 about-bg relative overflow-hidden">
        ...
        <div className="flex flex-col gap-7.5 items-center relative z-2">
          ...
          <p className="text-xl text-white max-w-[75ch] text-center">
