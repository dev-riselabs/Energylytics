...
function ManagementSuite() {
  return <section className="py-12 md:py-20 px-5 sm:px-7 md:px-10 lg:px-15 font-inter flex flex-col gap-6 md:gap-10 items-center bg-zinc800">
      <h2 className="text-slate text-xl sm:text-2xl font-medium text-center">Enterprise-grade Smart Management Suite</h2>
